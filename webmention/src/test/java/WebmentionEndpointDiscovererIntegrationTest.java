...
class WebmentionEndpointDiscovererIntegrationTest {
    ...
    public static Stream<Arguments> discover() {
        return Stream.of(
                ...
                Arguments.of("Discovery Test #11 - Multiple Webmention endpoints advertised: Link, <link>, <a>", "https://webmention.rocks/test/11", "https://webmention.rocks/test/11/webmention"),
                ...
                Arguments.of("Discovery Test #15 - Webmention href is an empty string", "https://webmention.rocks/test/15", "https://webmention.rocks/test/15"),
                Arguments.of("Discovery Test #16 - Multiple Webmention endpoints advertised: <a>, <link>", "https://webmention.rocks/test/16", "https://webmention.rocks/test/16/webmention"),
                Arguments.of("Discovery Test #17 - Multiple Webmention endpoints advertised: <link>, <a>", "https://webmention.rocks/test/17", "https://webmention.rocks/test/17/webmention"),
                ...
                Arguments.of("Discovery Test #21 - Webmention endpoint has query string parameters", "https://webmention.rocks/test/21", "https://webmention.rocks/test/21/webmention?query=yes"),
                Arguments.of("Discovery Test #22 - Webmention endpoint is relative to the path", "https://webmention.rocks/test/22", "https://webmention.rocks/test/22/22/webmention")
                ...
                //Arguments.of("Discovery Test #23 - Webmention target is a redirect and the endpoint is relative", "https://webmention.rocks/test/23/page", "https://webmention.rocks/test/23/webmention")
        );
    }
    ...
    void discover(@SuppressWarnings("unused") String name, String targetUrl, String expected) {
        // act
        var result = sut.discover(targetUrl).orElse(null);
