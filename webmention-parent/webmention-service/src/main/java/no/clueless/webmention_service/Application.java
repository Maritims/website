...
public class Application {
    public static void main(String[] args) {
        ...
        var receiver                     = WebmentionReceiver.newBuilder().httpClient(httpClient).requestVerifier(requestVerifier).repository(new SqliteWebmentionRepository(connectionString).initialize()).build();
